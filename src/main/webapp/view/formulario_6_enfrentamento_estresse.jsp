<%-- 
    Document   : formulario_enfrentamento_estresse
    Created on : 26/06/2015, 16:18:48
    Author     : 121151384
--%>
    <head>
        <title>HGSCCU - Cadastro de Paciente 6/8</title>
    </head>
    <body>
        <div class="container">
            <!--Cabeçalho-->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_6_enfrentamento_estresse.jsp'" class="btn btn-default" disabled="disabled">Enfr./Toler. ao Estresse</button>
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <!--Domínio 1-->
                        <jsp:include 
                            page="/view/instrumento_coleta/6_enfrentamento_estresse.jsp" 
                            flush="true"/>
                    </div>   
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_5_atividade_repouso.jsp'" type="submit" class="btn btn-default">Voltar</button>
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_7_seguranca_protecao.jsp'" type="submit" class="btn btn-default">Avançar</button>
                </div>
            </div>            
        </div> <!-- /container -->
    </body>
