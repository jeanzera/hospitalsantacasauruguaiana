        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <button onclick="parent.location.href = '/santacasauruguaiana/view/formulario_2_promocao_saude.jsp'" class="btn btn-default" disabled="disabled">Promoção da Saúde</button>
                ...
                <div class="panel-body">
                    ...
                    <button onclick="parent.location.href = '/santacasauruguaiana/view/formulario_3_nutricao.jsp'" type="submit" class="btn btn-default">Avançar</button>
                </div>
            </div>            
        </div> <!-- /container -->
    </body>
