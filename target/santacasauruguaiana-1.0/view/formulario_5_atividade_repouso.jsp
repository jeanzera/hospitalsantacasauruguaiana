<%-- 
    Document   : formulario_atividade_repouso
    Created on : 26/06/2015, 16:15:21
    Author     : 121151384
--%>
    <head>
        <title>HGSCCU - Cadastro de Paciente 5/8</title>
    </head>
    <body>
        <div class="container">
            <!--Cabeçalho-->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_5_atividade_repouso.jsp'" class="btn btn-default" disabled="disabled">Atividade/Repouso</button>
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <!--Domínio 1-->
                        <jsp:include 
                            page="/view/instrumento_coleta/5_atividade_repouso.jsp" 
                            flush="true"/>
                    </div>   
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_4_eliminacao_troca.jsp'" type="submit" class="btn btn-default">Voltar</button>
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_6_enfrentamento_estresse.jsp'" type="submit" class="btn btn-default">Avançar</button>
                </div>
            </div>            
        </div> <!-- /container -->
    </body>
