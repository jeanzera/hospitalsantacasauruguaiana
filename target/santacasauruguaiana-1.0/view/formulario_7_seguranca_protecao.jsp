<%-- 
    Document   : formulario_seguranca_protecao
    Created on : 26/06/2015, 16:22:05
    Author     : 121151384
--%>
    <head>
        <title>HGSCCU - Cadastro de Paciente 7/8</title>
    </head>
    <body>
        <div class="container">
            <!--Cabeçalho-->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_7_seguranca_protecao.jsp'" class="btn btn-default" disabled="disabled">Segurança/Proteção</button>
                ...
                <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <!--Domínio 1-->
                        <jsp:include 
                            page="/view/instrumento_coleta/7_seguranca_protecao.jsp" 
                            flush="true"/>
                    </div>   
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_6_enfrentamento_estresse.jsp'" type="submit" class="btn btn-default">Voltar</button>
                    <button onclick="parent.location.href='/santacasauruguaiana/view/formulario_8_conforto.jsp'" type="submit" class="btn btn-default">Avançar</button>
                </div>
            </div>            
        </div> <!-- /container -->
    </body>
