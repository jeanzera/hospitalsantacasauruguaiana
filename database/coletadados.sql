...
CREATE TABLE `alteracoes_abdome` (
  ...
  CONSTRAINT `fk_prontuario2` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `alteracoes_mobilidade` (
  ...
  CONSTRAINT `fk_prontuario1` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom11_classe2` (
  ...
  CONSTRAINT `fk_prontuario4` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom11_classe6` (
  ...
  CONSTRAINT `fk_prontuario5` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom12_classe1` (
  ...
  CONSTRAINT `fk_prontuario6` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom1_classe2` (
  ...
  CONSTRAINT `fk_prontuario7` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom2_classe1` (
  ...
  CONSTRAINT `fk_prontuario8` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom3_classe2` (
  ...
  CONSTRAINT `fk_prontuario9` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom4_classe2` (
  ...
  CONSTRAINT `fk_prontuario10` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom4_classe4` (
  ...
  CONSTRAINT `fk_prontuario12` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom4_classe5` (
  ...
  CONSTRAINT `fk_prontuario13` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd1_dom9_classe2` (
  ...
  CONSTRAINT `fk_prontuario14` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd2_dom11_classe2` (
  ...
  CONSTRAINT `fk_prontuario15` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd2_dom11_classe6` (
  ...
  CONSTRAINT `fk_prontuario16` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd2_dom12_classe1` (
  ...
  CONSTRAINT `fk_prontuario17` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd2_dom1_classe2` (
  ...
  CONSTRAINT `fk_prontuario18` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cd2_dom3_classe2` (
  ...
  CONSTRAINT `fk_prontuario19` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coloracao_pele` (
  ...
  CONSTRAINT `fk_prontuario20` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `exsudato` (
  ...
  CONSTRAINT `fk_lesao1` FOREIGN KEY (`lesao`) REFERENCES `lesao` (`idlesao`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom11_classe1` (
  ...
  CONSTRAINT `fk_prontuario22` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom11_classe2` (
  ...
  CONSTRAINT `fk_pontuario23` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom11_classe6` (
  ...
  CONSTRAINT `fk_prontuario24` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom12_classe1` (
  ...
  CONSTRAINT `fk_prontuario25` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom1_classe2` (
  ...
  CONSTRAINT `fk_prontuario26` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom2_classe1` (
  ...
  CONSTRAINT `fk_prontuario27` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom2_classe4` (
  ...
  CONSTRAINT `fk_prontuario28` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom3_classe2` (
  ...
  CONSTRAINT `fk_prontuario29` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom4_classe2` (
  ...
  CONSTRAINT `fk_prontuario30` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom4_classe4` (
  ...
  CONSTRAINT `fk_prontuario31` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom4_classe5` (
  ...
  CONSTRAINT `fk_prontuario32` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr1_dom9_classe2` (
  ...
  CONSTRAINT `fk_prontuario33` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr2_dom11_classe2` (
  ...
  CONSTRAINT `fk_prontuario34` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr2_dom12_classe1` (
  ...
  CONSTRAINT `fk_prontuario35` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr2_dom1_classe2` (
  ...
  CONSTRAINT `fk_prontuario36` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fr2_dom3_classe2` (
  ...
  CONSTRAINT `fk_prontuario37` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `glicemia` (
  ...
  CONSTRAINT `fk_prontuario38` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `historia_familiar_fatores_risco` (
  ...
  CONSTRAINT `fk_prontuario39` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `leito` (
  ...
  KEY `leito_idx` (`lesao`),
  CONSTRAINT `fk_lesao2` FOREIGN KEY (`lesao`) REFERENCES `lesao` (`idlesao`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lesao` (
  ...
  CONSTRAINT `fk_prontuario50` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lesoes_pele` (
  ...
  CONSTRAINT `fk_prontuario40` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `paciente` (
  ...
  `servico_ref` varchar(245) DEFAULT NULL,
  ...
  CONSTRAINT `prontuario` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `paciente` VALUES (30,'Paciente Um','feminino','Tibush','Professora',1,2,'Alecrim','Pai 33323206','rural','1996-01-15 00:00:00','TomÃ©',2,2,3,3,'casa','3323206',NULL,'02226598'),(32,'Jean Avila Rangel','masculino','CaiboatÃ©','Estudante',1,4,'Ijuiense','Pai 33323206','urbana','1994-07-18 00:00:00','Alegrete',2,1,3,1,'Unipampa','05598652514',NULL,'1107323998'),(33,'Maria Helena','feminino','Tiradentes','Professora',1,4,'Ijuiense','Pai 33323206','urbana','1965-01-05 00:00:00','IjuÃ­',2,3,3,1,'ccgl','33323206',NULL,'05661618'),(34,'Anita Garibaldi','feminino','Osvaldo 26','EscrivÃ£',1,4,'CaÃ§apava','Tio 3205151214','rural','1945-05-16 00:00:00','RosÃ¡rio',2,4,3,1,'Casa das mulheres','05532321548',NULL,'15151230584'),(35,'fdsafdsa','masculino','fdsafdsa','fdsafdsa',1,1,'fdsafds','fdsafds','urbana','1995-05-15 00:00:00','fdasf',2,1,3,1,'fdasfdas','33323206',NULL,'3253235'),(36,'shgf','masculino','hgfh','hgdfh',1,1,'fgdh','gfdhgfd','urbana','1554-05-15 00:00:00','fdg',2,1,3,1,'Unipampa','33323206',NULL,'1107323998'),(37,'jhgj','masculino','hgjf','jhgjhg',1,1,'jhgfj','hgj','urbana','1884-12-18 00:00:00','jhgjf',2,1,3,1,'jhgjhg','jhfj',NULL,'61516'),(38,'hgjhhg','masculino','jhfjh','gfjhgjhh',1,1,'gjhhf','jhhf','urbana','9999-12-15 00:00:00','jhgjhg',2,1,3,1,'hgjhg','jhgjhg',NULL,'65768765'),(39,'jhgjh','masculino','jhgjhg','jhgjhg',1,1,'jhgjhg','jhgjhg','urbana','1994-12-18 00:00:00','jhgjhg',2,1,3,3,'jhgjf','jhfgj',NULL,'61851819'),(40,'kjlkjl','masculino','kjlk','jlhkjhl',1,1,'kjhlkjhlkj','lkjhlkjh','urbana','1815-08-12 00:00:00','jhgfjhf',2,1,3,1,'jhgjhf','jhfjhfjhg',NULL,'65765765'),(41,'gfdg','masculino','gfdsgfd','jhgjhg',1,1,'fdsa','erwtrewt','urbana','1554-12-15 00:00:00','rgfds',2,1,3,1,'gfdsgfds','gfdsgfds',NULL,'1181891'),(42,'tretr','masculino','gre','gregre',1,1,'gregre','gregre','urbana','1433-12-12 00:00:00','432432',2,1,3,1,'432432','432423',NULL,'423432'),(43,'gfssg','masculino','gfdsgfdsfds','gfdsgf',1,1,'gfdsggfds','gfdgfds','urbana','1333-12-12 00:00:00','324',2,1,3,1,'423','432',NULL,'423423'),(44,'gfdgf','masculino','gfdsgfd','gfdsg',1,1,'gfds','gfds','urbana','1965-12-12 00:00:00','gfdsg',2,2,3,1,'gfs','fds',NULL,'23'),(45,'fdss','masculino','fdsaffdsa','fdsa',1,3,'fdasf','fdsa','urbana','1965-12-05 00:00:00','fdsa',2,1,3,1,'fsda','fdsaf',NULL,'32'),(46,'fdsaf','masculino','fsda','fdsa',1,1,'sÃ£o sepÃ©','fda','urbana','1995-12-12 00:00:00','fdsafdas',2,1,3,1,'fdas','fsda',NULL,'32'),(47,'fdsa','masculino','fdsa','fds',1,2,'fds','fdsa','urbana','1965-12-12 00:00:00','fds',2,1,3,1,'fds','fds',NULL,'323'),(48,'afdsfdsa','masculino','fdsafdsa','fddfa',1,3,'fdsafdasfds','fdasf','urbana','1222-12-12 00:00:00','dsaf',2,1,3,1,'fdsafd','fdsfdas',NULL,'32432');
...
CREATE TABLE `perfusao_periferica` (
  ...
  UNIQUE KEY `idperfusao_periferica_UNIQUE` (`prontuario`),
  KEY `perfusao_periferica_idx` (`prontuario`),
  CONSTRAINT `fk_prontuario41` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pressao_arterial` (
  ...
  CONSTRAINT `fk_prontuario42` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prontuario` (
  ...
  `motivo_atendimento` varchar(245) DEFAULT NULL,
  `estado_saude` varchar(245) DEFAULT NULL,
  `historia_outras` varchar(245) DEFAULT NULL,
  `hosp_previa` tinyint(1) DEFAULT NULL,
  `real_cirurgias` tinyint(1) DEFAULT NULL,
  `quais_cirurgias` varchar(245) DEFAULT NULL,
  `utiliza_medic` tinyint(1) DEFAULT NULL,
  `utiliza_medic_adeq` tinyint(1) DEFAULT NULL,
  `medic_preescrito` varchar(245) DEFAULT NULL,
  `medic_nao_preescrito` varchar(245) DEFAULT NULL,
  `alergico` tinyint(1) DEFAULT NULL,
  `alergico_quais` varchar(245) DEFAULT NULL,
  `de_00099` tinyint(1) DEFAULT NULL,
  `de_00043` tinyint(1) DEFAULT NULL,
  `observ_dom1_classe2` varchar(245) DEFAULT NULL,
  `alter_nutricao` tinyint(1) DEFAULT NULL,
  `de_00001` tinyint(1) DEFAULT NULL,
  `observ_dom2_classe1` varchar(245) DEFAULT NULL,
  `alter_glicemia` tinyint(1) DEFAULT NULL,
  `valor_glicemia` int(11) DEFAULT NULL,
  `de_00179` tinyint(1) DEFAULT NULL,
  `observ_dom2_classe4` varchar(245) DEFAULT NULL,
  `alter_abdome` tinyint(1) DEFAULT NULL,
  `ruidos_hidroaereos` tinyint(1) DEFAULT NULL,
  `alter_elimin_intestinal` tinyint(1) DEFAULT NULL,
  `freq_elimin_intestinal` varchar(245) DEFAULT NULL,
  `quant_elimin_intestinal` varchar(245) DEFAULT NULL,
  `tipo_alter_elimin_intestinal` varchar(245) DEFAULT NULL,
  `de_00011` tinyint(1) DEFAULT NULL,
  `de_00013` tinyint(1) DEFAULT NULL,
  `observ_dom3_classe2` varchar(245) DEFAULT NULL,
  `alter_forca` tinyint(1) DEFAULT NULL,
  `alter_mobilidade` tinyint(1) DEFAULT NULL,
  `de_00085` tinyint(1) DEFAULT NULL,
  `observ_dom4_classe2` varchar(245) DEFAULT NULL,
  `freq_cardiaca` float DEFAULT NULL,
  `medida_pressao` float DEFAULT NULL,
  `de_00204` tinyint(1) DEFAULT NULL,
  `observ_dom4_classe4` varchar(245) DEFAULT NULL,
  `auxilio_higiene` tinyint(1) DEFAULT NULL,
  `tipo_auxilio_higiene` varchar(245) DEFAULT NULL,
  `de_00108` tinyint(1) DEFAULT NULL,
  `observ_dom4_classe5` varchar(245) DEFAULT NULL,
  `perda_estresse` tinyint(1) DEFAULT NULL,
  `de_00146` tinyint(1) DEFAULT NULL,
  `observ_dom9_classe2` varchar(245) DEFAULT NULL,
  `outras_vacinas` varchar(245) DEFAULT NULL,
  `de_00004` tinyint(1) DEFAULT NULL,
  `observ_dom11_classe1` varchar(245) DEFAULT NULL,
  `alteracoes_pele` tinyint(1) DEFAULT NULL,
  `outras_alteracoes_pele` varchar(245) DEFAULT NULL,
  `recuper_imediata` tinyint(1) DEFAULT NULL,
  `espec_cirurgia` varchar(245) DEFAULT NULL,
  `presenc_lesoes` tinyint(1) DEFAULT NULL,
  `de_00046` tinyint(1) DEFAULT NULL,
  `de_recup_retardada` tinyint(1) DEFAULT NULL,
  `observ_dom11_classe2` varchar(245) DEFAULT NULL,
  ...
  `observ_dom11_classe6` varchar(245) DEFAULT NULL,
  `avaliacao_dor` varchar(245) DEFAULT NULL,
  `escala_dor` int(11) DEFAULT NULL,
  `de_00132` tinyint(1) DEFAULT NULL,
  `de_00133` tinyint(1) DEFAULT NULL,
  `observ_dom12_classe1` varchar(245) DEFAULT NULL,
  ...
  CONSTRAINT `paciente` FOREIGN KEY (`paciente`) REFERENCES `paciente` (`idpaciente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `prontuario` VALUES (2,3,36,4,'motivo','estadoo','historiass',1,1,'quaiscirur',0,0,'prescritoo','nao pres',0,'nenhumquais alergic',1,1,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,23,'2015-09-11','2015-09-11'),(5,1222,43,1223,'123','fdas','',0,0,'',0,1,'','',0,'',1,1,'',0,1,'tá bem',0,333,0,'',0,0,0,'varias','muito','',0,0,'',0,0,0,'',546,555,0,'',1,'',0,'',0,0,'testando2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,26,'2015-09-14','2015-09-14'),(6,5151,47,5161,'561561','fds','',0,0,'',0,1,'','',0,'',1,1,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,26,'2015-09-14','2015-09-14');
...
CREATE TABLE `qualidade_dor` (
  ...
  CONSTRAINT `fk_prontuario43` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ruidos_hidroaereos` (
  ...
  CONSTRAINT `fk_prontuario44` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sinais_infeccao` (
  ...
  CONSTRAINT `fk_prontuario45` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipo_debridamento` (
  ...
  CONSTRAINT `fk_lesao4` FOREIGN KEY (`lesao`) REFERENCES `lesao` (`idlesao`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `umidade_pele` (
  ...
  CONSTRAINT `fk_prontuario47` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `upp` (
  ...
  CONSTRAINT `fk_prontuario48` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (22,'Jean Rangel','jean@admin.com','jeanrangel','123456',1,1),(23,'Enfermeiro da costa','enfermeiro@teste.com','enfermeiro123','okofdkofkd',0,1),(24,'Administrador Um','admin@suporte.com','ADMMNM','senhapasss212',1,1),(25,'Artur Orion','artur@irion.com','arturorion','irion',1,1),(26,'Avelino Avila','avelino@avila.com','ave1234','123',0,1),(28,'fDSF','FDSF','enfgff','okogfg',0,1),(29,'gfsdgfdfg','gfg','gfgf','okogfg',0,1);
...
CREATE TABLE `vacinas_realizadas` (
  ...
  CONSTRAINT `fk_prontuario49` FOREIGN KEY (`prontuario`) REFERENCES `prontuario` (`prontuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-09-17 17:23:58
